...
"""
EntPTC Feature Extraction - FINAL VERSION
Uses existing EntPTC model to process real .mat files
"""
...
print("=" * 80)
print("EntPTC Feature Extraction - Using Existing Model")
print("=" * 80)
...
for idx, mat_file in enumerate(mat_files):
 ...
 # Build Progenitor Matrix using existing model
