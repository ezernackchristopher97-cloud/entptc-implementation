...
"""EntPTC Feature Extraction - CORRECTED - Uses REAL existing model methods"""
import numpy as np
import h5py
import os
import csv
...
print("=" * 80)
print("EntPTC Feature Extraction - Using REAL Existing Model")
print("=" * 80)
...
for idx, mat_file in enumerate(mat_files):
 ...
 # Build Progenitor Matrix using REAL existing model method
 progenitor_matrix = progenitor_builder.construct_from_eeg_data(roi_data)
 
 # Perron-Frobenius using REAL existing model method
