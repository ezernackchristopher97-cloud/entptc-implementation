# TRANSITION INSTRUCTIONS FOR GITHUB UPLOAD

## MISSION
Upload the EntPTC 40-subject cohort metadata deliverables to the user's GitHub account.

## CONTEXT
All metadata files are ready at `/home/ubuntu/deliverables_metadata_only/`. These are METADATA-ONLY files (168 KB total) - NO large EDF binaries, NO Git LFS required.
