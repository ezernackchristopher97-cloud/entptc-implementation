...
Per-subject summary showing pre and post file pairs.
...
- exclusion_reason_if_any - Exclusion reason
...
4. Analyze data using pre and post pairs from subject_summary.csv
